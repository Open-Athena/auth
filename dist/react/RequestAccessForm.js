 ...
 */
export function RequestAccessForm({ endpoint = '/api/auth/request', honeypotField = 'website', askName = true, askNote = true, notePlaceholder = 'Anything that helps us place you (optional)', defaultEmail, onSubmitted, classNames = {}, labels = {}, }) {
